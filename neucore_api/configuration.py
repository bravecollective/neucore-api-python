...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of neucore_api.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = neucore_api.Configuration(
    ...
    Note you can use the constants defined in the neucore_api.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = neucore_api.Configuration(
        signing_info = neucore_api.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="https://localhost/api",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("neucore_api")

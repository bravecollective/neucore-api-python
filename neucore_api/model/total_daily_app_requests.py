...
class TotalDailyAppRequests(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, requests, year, month, day_of_month, *args, **kwargs):  # noqa: E501
        """TotalDailyAppRequests - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, requests, year, month, day_of_month, *args, **kwargs):  # noqa: E501
        """TotalDailyAppRequests - a model defined in OpenAPI

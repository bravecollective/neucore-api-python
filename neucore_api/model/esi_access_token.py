...
class EsiAccessToken(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, token, scopes, expires, *args, **kwargs):  # noqa: E501
        """EsiAccessToken - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, token, scopes, expires, *args, **kwargs):  # noqa: E501
        """EsiAccessToken - a model defined in OpenAPI

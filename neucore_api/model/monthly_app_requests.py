...
class MonthlyAppRequests(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, app_id, app_name, requests, year, month, *args, **kwargs):  # noqa: E501
        """MonthlyAppRequests - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, app_id, app_name, requests, year, month, *args, **kwargs):  # noqa: E501
        """MonthlyAppRequests - a model defined in OpenAPI

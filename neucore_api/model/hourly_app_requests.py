...
class HourlyAppRequests(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, app_id, app_name, requests, year, month, day_of_month, hour, *args, **kwargs):  # noqa: E501
        """HourlyAppRequests - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, app_id, app_name, requests, year, month, day_of_month, hour, *args, **kwargs):  # noqa: E501
        """HourlyAppRequests - a model defined in OpenAPI

...
class ServiceAccount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, service_id, service_name, character_id, username, status, display_name, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, service_id, service_name, character_id, username, status, display_name, *args, **kwargs):  # noqa: E501
        """ServiceAccount - a model defined in OpenAPI

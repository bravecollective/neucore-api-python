...
class ServiceConfigurationURL(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, url, title, target, *args, **kwargs):  # noqa: E501
        """ServiceConfigurationURL - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, url, title, target, *args, **kwargs):  # noqa: E501
        """ServiceConfigurationURL - a model defined in OpenAPI

...
class CharacterGroups(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, character, groups, deactivated, *args, **kwargs):  # noqa: E501
        """CharacterGroups - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, character, groups, deactivated, *args, **kwargs):  # noqa: E501
        """CharacterGroups - a model defined in OpenAPI

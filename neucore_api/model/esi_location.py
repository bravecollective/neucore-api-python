...
class EsiLocation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, category, name, *args, **kwargs):  # noqa: E501
        """EsiLocation - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, category, name, *args, **kwargs):  # noqa: E501
        """EsiLocation - a model defined in OpenAPI

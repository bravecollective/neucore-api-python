...
class GroupApplication(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, player, group, created, *args, **kwargs):  # noqa: E501
        """GroupApplication - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            status (str): Group application status.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, player, group, created, *args, **kwargs):  # noqa: E501
        """GroupApplication - a model defined in OpenAPI

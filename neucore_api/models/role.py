...
class Role(object):
    ...
    allowable_values = [APP, APP_GROUPS, APP_CHARS, APP_TRACKING, APP_ESI, USER, USER_ADMIN, USER_MANAGER, USER_CHARS, GROUP_ADMIN, GROUP_MANAGER, APP_ADMIN, APP_MANAGER, ESI, SETTINGS, TRACKING, TRACKING_ADMIN, WATCHLIST, WATCHLIST_MANAGER, WATCHLIST_ADMIN]  # noqa: E501

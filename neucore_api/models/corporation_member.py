...
class CorporationMember(object):
    ...
    openapi_types = {
        ...
        'missing_character_mail_sent_result': 'str',
    ...
    def __init__(self, player=None, id=None, name=None, location=None, logoff_date=None, logon_date=None, ship_type=None, start_date=None, character=None, missing_character_mail_sent_date=None, missing_character_mail_sent_result=None, missing_character_mail_sent_number=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def missing_character_mail_sent_date(self):
        """Gets the missing_character_mail_sent_date of this CorporationMember.  # noqa: E501

        Date and time of the last sent mail.  # noqa: E501

        :return: The missing_character_mail_sent_date of this CorporationMember.  # noqa: E501
        :rtype: datetime
        """
        return self._missing_character_mail_sent_date

    @missing_character_mail_sent_date.setter
    def missing_character_mail_sent_date(self, missing_character_mail_sent_date):
        """Sets the missing_character_mail_sent_date of this CorporationMember.

        Date and time of the last sent mail.  # noqa: E501

        :param missing_character_mail_sent_date: The missing_character_mail_sent_date of this CorporationMember.  # noqa: E501
        :type: datetime
        """

        self._missing_character_mail_sent_date = missing_character_mail_sent_date

    @property
    def missing_character_mail_sent_result(self):
        """Gets the missing_character_mail_sent_result of this CorporationMember.  # noqa: E501

        Result of the last sent mail (OK, Blocked, CSPA charge > 0)  # noqa: E501

        :return: The missing_character_mail_sent_result of this CorporationMember.  # noqa: E501
        :rtype: str
        """
        return self._missing_character_mail_sent_result

    @missing_character_mail_sent_result.setter
    def missing_character_mail_sent_result(self, missing_character_mail_sent_result):
        """Sets the missing_character_mail_sent_result of this CorporationMember.

        Result of the last sent mail (OK, Blocked, CSPA charge > 0)  # noqa: E501

        :param missing_character_mail_sent_result: The missing_character_mail_sent_result of this CorporationMember.  # noqa: E501
        :type: str
        """

        self._missing_character_mail_sent_result = missing_character_mail_sent_result

    @property
    def missing_character_mail_sent_number(self):
        """Gets the missing_character_mail_sent_number of this CorporationMember.  # noqa: E501

        Number of mails sent, is reset when the character is added.  # noqa: E501

        :return: The missing_character_mail_sent_number of this CorporationMember.  # noqa: E501
        :rtype: int
        """
        return self._missing_character_mail_sent_number

    @missing_character_mail_sent_number.setter
    def missing_character_mail_sent_number(self, missing_character_mail_sent_number):
        """Sets the missing_character_mail_sent_number of this CorporationMember.

        Number of mails sent, is reset when the character is added.  # noqa: E501

        :param missing_character_mail_sent_number: The missing_character_mail_sent_number of this CorporationMember.  # noqa: E501
        :type: int
        """

        self._missing_character_mail_sent_number = missing_character_mail_sent_number

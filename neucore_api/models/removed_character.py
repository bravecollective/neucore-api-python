...
class RemovedCharacter(object):
    ...
    def __init__(self, new_player_id=None, new_player_name=None, character_id=None, character_name=None, removed_date=None, reason=None, deleted_by=None):  # noqa: E501

...
class RemovedCharacter(object):
    ...
    def __init__(self, new_player_id=None, new_player_name=None, character_id=None, character_name=None, removed_date=None, action=None):  # noqa: E501
    ...
    @property
    def action(self):
        """Gets the action of this RemovedCharacter.  # noqa: E501

        How it was removed (deleted or moved to another account).  # noqa: E501

        :return: The action of this RemovedCharacter.  # noqa: E501
        :rtype: str
        """
        return self._action
    ...
    def action(self, action):
        """Sets the action of this RemovedCharacter.

        How it was removed (deleted or moved to another account).  # noqa: E501

        :param action: The action of this RemovedCharacter.  # noqa: E501
        :type: str
        """
        if action is None:

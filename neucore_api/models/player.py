...
class Player(object):
    ...
    openapi_types = {
        ...
        'incoming_characters': 'list[RemovedCharacter]'
    }
    ...
    def __init__(self, id=None, name=None, status=None, roles=None, characters=None, groups=None, manager_groups=None, manager_apps=None, removed_characters=None, incoming_characters=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def incoming_characters(self):
        """Gets the incoming_characters of this Player.  # noqa: E501

        Characters that were moved from another player account to this account (API: not included by default).  # noqa: E501

        :return: The incoming_characters of this Player.  # noqa: E501
        :rtype: list[RemovedCharacter]
        """
        return self._incoming_characters

    @incoming_characters.setter
    def incoming_characters(self, incoming_characters):
        """Sets the incoming_characters of this Player.

        Characters that were moved from another player account to this account (API: not included by default).  # noqa: E501

        :param incoming_characters: The incoming_characters of this Player.  # noqa: E501
        :type: list[RemovedCharacter]
        """

        self._incoming_characters = incoming_characters

...
class ApplicationCharactersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.players_v1_endpoint = _Endpoint(
            settings={
                'response_type': ([PlayerWithCharcterId],),
                'auth': [
                    'BearerAuth'
                ],
                'endpoint_path': '/app/v1/players',
                'operation_id': 'players_v1',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def players_v1(
        ...
        **kwargs
        ...
        """Returns player accounts identified by character IDs. Can contain the same player several times.  # noqa: E501

        Needs role: app-chars.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.players_v1(request_body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['request_body'] = \
            request_body
        return self.players_v1_endpoint.call_with_http_info(**kwargs)

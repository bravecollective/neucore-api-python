...
class ApplicationESIApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.esi_access_token_v1_endpoint = _Endpoint(
            settings={
                'response_type': (EsiAccessToken,),
                'auth': [
                    'BearerAuth'
                ],
                'endpoint_path': '/app/v1/esi/access-token/{characterId}',
                'operation_id': 'esi_access_token_v1',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'eve_login_name': 'eveLoginName',
                },
                'location_map': {
                    'character_id': 'path',
                    'eve_login_name': 'query',
                },
        ...
        self.esi_post_v1_endpoint = _Endpoint(
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'neucore_eve_character': 'Neucore-EveCharacter',
                    'neucore_eve_login': 'Neucore-EveLogin',
                },
                'location_map': {
                    'esi_path_query': 'query',
                    'datasource': 'query',
                    'body': 'body',
                    'neucore_eve_character': 'header',
                    'neucore_eve_login': 'header',
                },
                'collection_format_map': {
                }
            },
    ...
    def esi_access_token_v1(
        self,
        character_id,
        **kwargs
    ):
        """Returns an access token for a character and EVE login.  # noqa: E501

        Needs role: app-esi-token  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.esi_access_token_v1(character_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['character_id'] = \
            character_id
        return self.esi_access_token_v1_endpoint.call_with_http_info(**kwargs)
    ...
    def esi_eve_login_characters_v1(
        ...
        **kwargs
        ...
        Needs role: app-esi-login.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def esi_v2(
        ...
        **kwargs
        ...
        >>> thread = api.esi_v2(esi_path_query, async_req=True)
        >>> result = thread.get()

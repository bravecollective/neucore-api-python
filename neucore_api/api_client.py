...
from neucore_api import rest
from neucore_api.configuration import Configuration
from neucore_api.exceptions import ApiTypeError, ApiValueError, ApiException
from neucore_api.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.show_v1  # this is an instance of the class Endpoint
        api_instance.show_v1()  # this invokes api_instance.show_v1.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.show_v1.callable or self.callable in this class

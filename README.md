...
*ApplicationCharactersApi* | [**players_v1**](docs/ApplicationCharactersApi.md#players_v1) | **POST** /app/v1/players | Returns player accounts identified by character IDs. Can contain the same player several times.
...
*ApplicationESIApi* | [**esi_access_token_v1**](docs/ApplicationESIApi.md#esi_access_token_v1) | **GET** /app/v1/esi/access-token/{characterId} | Returns an access token for a character and EVE login.
